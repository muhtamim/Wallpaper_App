...
import bluemwall.mhussain96.com.bluemwall.Database.DataSource.RecentRepository;
import bluemwall.mhussain96.com.bluemwall.Database.LocalDatabase.LocalDatabase;
import bluemwall.mhussain96.com.bluemwall.Database.LocalDatabase.RecentsDataSource;
import bluemwall.mhussain96.com.bluemwall.Database.Recents;
import bluemwall.mhussain96.com.bluemwall.Helper.SaveImageHelper;
            ...
            case Common.PERMISSION_REQUEST_CODE:
            {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    ...
                    Picasso.with(getBaseContext()).load(Common.select_background.getImageUrl()).into(new SaveImageHelper(getBaseContext(),dialog, getApplicationContext()
                            .getContentResolver(), fileName, "Wallpaper Image"));
                }
                else {
